...
Insulink offers some useful tools to keep track of the daily routine of a patient. 
	...
	to calculate the optimal insulin dose for the given meal. A more detailed explaintation can be fount in the Insulin Calculator Section ---/cite section---.
...
\vspace{10.5cm}
	...
	\begin{docCommand}{utils}{}
		Logic of API, authentication, Firebase and Insuline Calculator
	\end{docCommand}

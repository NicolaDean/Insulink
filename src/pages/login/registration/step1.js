        ...
        <View>
            ...
            <InputBlock name={"Login Info:"}>
                <InputContainer name={"Email  "}>
                    <TextInput value={userData.email} testID={"EmailID"}style={styles.textInput} keyboardType="email-address" onChangeText={val => setUserData(userDataTypes.email,val)}/>
                </InputContainer>
                <InputContainer name={"Password  "}>
                    <TextInput  style={styles.textInput} testID={"PswID"} secureTextEntry={true} onChangeText={val => setUserData(userDataTypes.password,val)}/>
                </InputContainer>
            </InputBlock>

    ...
    {   onPress,
        ...
        return(
            <TouchableOpacity  disabled={disabled} onPress={onPress} style={style}>
                    <View  style={image == 'dose' ?styles.appButtonContainerRound: (image =='glucose' || image== 'statistics'|| image== 'calendar' || image=='defaultDiet')? styles.appButtonContainerSquare: null}>
